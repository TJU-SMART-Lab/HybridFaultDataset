...
for now_idv_0 = 1:20
    for now_idv_1 = 1:20
        for now_idv_2 = 1:20
            if now_idv_0 == now_idv_1 || now_idv_1 == now_idv_2 || now_idv_0 == now_idv_2
                continue
            end
            
            current_idvs = strjoin(string(sort([now_idv_0, now_idv_1, now_idv_2])));
            ...
            for xmv5_idx = 1:10
                ...
                filename = strcat(num2str(now_idv_0), "_", num2str(now_idv_1), "_", num2str(now_idv_2), "_", sprintf("%.2f", this_xmv5), ".mat");
                if isfile(filename)
                    continue
                end
                ...
                this_idv = I(now_idv_0, :) + I(now_idv_1, :) + I(now_idv_2, :);
